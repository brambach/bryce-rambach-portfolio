...
Journey milestones now use aggregate Redis counters in the private /admin garage office. They measure browser-tab sessions separately from Vercel's visitor estimates. See garage-office.md for definitions and limitations.

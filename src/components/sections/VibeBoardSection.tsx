...
const [clayCourt, green911, meadow, snowboard] = vibeCards.filter(
  (c): c is Extract<VibeCard, { kind: 'photo' }> => c.kind === 'photo',
);
const note = vibeCards.find((c): c is Extract<VibeCard, { kind: 'note' }> => c.kind === 'note');

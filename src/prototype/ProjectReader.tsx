...
export default function ProjectReader() {
  return <main className="project-reader" aria-label="Bryce Rambach's personal portfolio">
    ...
    <footer className="project-reader__footer"><span>Bryce Rambach. Designer & engineer.</span><a href="https://github.com/brambach" target="_blank" rel="noreferrer">GitHub ↗</a></footer>
  </main>;
}
